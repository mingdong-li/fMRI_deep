...
if __name__ == '__main__':
    ...
    fmri_datasets['train'] = CreateNiiDataset(my_config.train_dir, my_config.train_pheno, my_config.train_csv)
    fmri_datasets['val'] =  ValNiiDataset(my_config.train_dir, my_config.train_pheno,
                            my_config.val_dir, my_config.val_pheno, my_config.val_csv)
