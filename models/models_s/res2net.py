...
if __name__ == '__main__':
    ...
    inputs2 = torch.rand(8, 1, 49, 58, 47)

    # model = res2net50(num_classes=512)
    model = test_res2net50(num_classes=512)
    
    output1, output2, c1, c2 = model(inputs1, inputs2)
    print(output1.shape)  # float32
    print(c1.shape)
